    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-sm p-4 border border-blue-200 dark:border-blue-800">
          ...
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{result.totalQuestions}</p>
        </div>
        ...
        <div className="bg-green-50 dark:bg-green-900/20 rounded-sm p-4 border border-green-200 dark:border-green-800">
          ...
          <p className="text-2xl font-bold text-green-600 dark:text-green-400">{result.answeredQuestions}</p>
        </div>
            ...
            {expandedSections.has(section.id) && (
              <div className="p-6 space-y-4">
                {section.questions.map((question) => (
                  <div
                    key={question.id}
                    className={`border rounded-sm p-4 ${getAnswerColor(question.answer)}`}
                  >

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">各维度成熟度评估</h3>
        ...
        {result.dimensions.map((dimension, index) => {
          ...
          return (
            <div
              key={dimension.id}
              className={`bg-white dark:bg-gray-900 rounded-lg p-5 border-2 transition-all cursor-pointer ${
                isSelected
                  ...
                  <div className="grid grid-cols-5 gap-2">
                    {dimension.scores.map((score, i) => (
                      ...
                      >
                        ...
                        <p className="text-lg font-semibold text-gray-900 dark:text-white">{score}</p>
                      </div>
                    ))}
                  </div>
                </div>

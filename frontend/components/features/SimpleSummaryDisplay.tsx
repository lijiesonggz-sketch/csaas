  ...
  return (
    <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {key_areas.map((area: KeyArea, index: number) => (
              <div
                key={index}
                className={`border-l-4 rounded-sm p-4 ${getImportanceColor(area.importance)}`}
              >
      ...
      {key_requirements && key_requirements.length > 0 && (
        <div className="bg-white dark:bg-gray-900 rounded-sm p-6 border border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">

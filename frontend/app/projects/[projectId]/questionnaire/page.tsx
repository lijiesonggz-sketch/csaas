...
export default function QuestionnairePage() {
  ...
  const [publishImpact, setPublishImpact] = useState<ProjectQuestionnairePublishImpactResponse | null>(null)
  ...
  const persistDraft = useCallback(async (): Promise<ProjectQuestionnaireSnapshotResponse | null> => {
    if (!snapshotInfo) {
      return null
    }
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#1E3A5F] p-8 mb-8">
        ...
        <div className="relative flex items-start justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            {isSnapshotMode && !isQuestionnaireEditable && snapshotInfo?.lifecycleStatus === 'published' && (
              <Button
            ...
            {isSnapshotMode && isQuestionnaireEditable && (
              <>
                ...
                <Button
                  ...
                  disabled={publishPending || savePending || (!hasUnsavedChanges && !isDraftSnapshot)}
      ...
      <Dialog open={leaveDialogOpen} onOpenChange={setLeaveDialogOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              variant="outline"
              onClick={handleConfirmLeaveDiscard}
            >
              放弃修改
            </Button>
            <Button
              onClick={() => void handleConfirmLeaveWithSave()}

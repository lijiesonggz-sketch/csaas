...
export class AddTaskProgressFields1767291591745 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."ai_tasks_generation_stage_enum" AS ENUM('pending', 'generating_models', 'quality_validation', 'aggregating', 'completed', 'failed')`);

        // Add generation_stage column
        await queryRunner.query(`ALTER TABLE "ai_tasks" ADD "generation_stage" "public"."ai_tasks_generation_stage_enum" NOT NULL DEFAULT 'pending'`);

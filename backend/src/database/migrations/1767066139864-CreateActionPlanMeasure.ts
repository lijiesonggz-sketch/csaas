...
export class CreateActionPlanMeasure1767066139864 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "survey_responses" DROP CONSTRAINT "FK_7b10bd08286c2d8cd854037fd3c"`,
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "created_at" SET DEFAULT now()`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "updated_at" SET DEFAULT now()`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ADD CONSTRAINT "FK_7b10bd08286c2d8cd854037fd3c" FOREIGN KEY ("questionnaire_task_id") REFERENCES "ai_tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
    await queryRunner.query(
      `ALTER TABLE "action_plan_measures" ADD CONSTRAINT "FK_c23acbc5e35b295359252d8a0c5" FOREIGN KEY ("task_id") REFERENCES "ai_tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "action_plan_measures" DROP CONSTRAINT "FK_c23acbc5e35b295359252d8a0c5"`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" DROP CONSTRAINT "FK_7b10bd08286c2d8cd854037fd3c"`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "updated_at" SET DEFAULT CURRENT_TIMESTAMP`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "created_at" SET DEFAULT CURRENT_TIMESTAMP`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "answers" SET DEFAULT '{}'`,
    )
    await queryRunner.query(
      `CREATE TYPE "public"."survey_status_old" AS ENUM('draft', 'submitted', 'completed')`,
    )
    await queryRunner.query(`ALTER TABLE "survey_responses" ALTER COLUMN "status" DROP DEFAULT`)
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "status" TYPE "public"."survey_status_old" USING "status"::"text"::"public"."survey_status_old"`,
    )
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ALTER COLUMN "status" SET DEFAULT 'draft'`,
    )
    ...
    await queryRunner.query(
      `ALTER TABLE "survey_responses" ADD CONSTRAINT "FK_7b10bd08286c2d8cd854037fd3c" FOREIGN KEY ("questionnaire_task_id") REFERENCES "ai_tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    )
  }
}

...
export class UpdateAITaskEntity1766633092012 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ai_generation_events" DROP CONSTRAINT "FK_ai_generation_events_task"`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" DROP CONSTRAINT "FK_ai_cost_tracking_task"`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_tasks" ADD "progress" double precision NOT NULL DEFAULT '0'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."ai_generation_events_model_enum" AS ENUM('gpt4', 'claude', 'domestic')`);
        await queryRunner.query(`ALTER TABLE "ai_generation_events" ALTER COLUMN "model" TYPE "public"."ai_generation_events_model_enum" USING "model"::"text"::"public"."ai_generation_events_model_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_cost_tracking_model_enum" AS ENUM('gpt4', 'claude', 'domestic')`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" ALTER COLUMN "model" TYPE "public"."ai_cost_tracking_model_enum" USING "model"::"text"::"public"."ai_cost_tracking_model_enum"`);
        await queryRunner.query(`DROP TYPE "public"."ai_model_enum_old"`);
        await queryRunner.query(`ALTER TYPE "public"."ai_task_type_enum" RENAME TO "ai_task_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_tasks_type_enum" AS ENUM('summary', 'clustering', 'matrix', 'questionnaire', 'action_plan')`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "type" TYPE "public"."ai_tasks_type_enum" USING "type"::"text"::"public"."ai_tasks_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."ai_task_type_enum_old"`);
        await queryRunner.query(`ALTER TYPE "public"."ai_task_status_enum" RENAME TO "ai_task_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_tasks_status_enum" AS ENUM('pending', 'processing', 'completed', 'failed', 'manual_mode', 'low_confidence')`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "status" TYPE "public"."ai_tasks_status_enum" USING "status"::"text"::"public"."ai_tasks_status_enum"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('consultant', 'client_pm', 'respondent')`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_generation_events" ADD CONSTRAINT "FK_dfd3bf4272d3882c7e7aaf37da0" FOREIGN KEY ("task_id") REFERENCES "ai_tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" ADD CONSTRAINT "FK_857f791a0de362bee9c613beda6" FOREIGN KEY ("task_id") REFERENCES "ai_tasks"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ADD CONSTRAINT "FK_c7388f0106b9d3609c35db87a61" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ai_tasks" DROP CONSTRAINT "FK_c7388f0106b9d3609c35db87a61"`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" DROP CONSTRAINT "FK_857f791a0de362bee9c613beda6"`);
        await queryRunner.query(`ALTER TABLE "ai_generation_events" DROP CONSTRAINT "FK_dfd3bf4272d3882c7e7aaf37da0"`);
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP COLUMN "action"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum_old" AS ENUM('consultant', 'client_pm', 'respondent')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."project_status_enum_old" AS ENUM('draft', 'active', 'completed', 'archived')`);
        await queryRunner.query(`ALTER TABLE "projects" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "ai_tasks" DROP COLUMN "priority"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_task_priority_enum" AS ENUM('low', 'medium', 'high')`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ADD "priority" "public"."ai_task_priority_enum" NOT NULL DEFAULT 'medium'`);
        await queryRunner.query(`CREATE TYPE "public"."ai_task_status_enum_old" AS ENUM('pending', 'running', 'completed', 'failed', 'timeout', 'low_confidence', 'manual_mode')`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "status" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "status" TYPE "public"."ai_task_status_enum_old" USING "status"::"text"::"public"."ai_task_status_enum_old"`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "status" SET DEFAULT 'pending'`);
        await queryRunner.query(`DROP TYPE "public"."ai_tasks_status_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."ai_task_status_enum_old" RENAME TO "ai_task_status_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_task_type_enum_old" AS ENUM('summary_generation', 'clustering', 'maturity_matrix', 'questionnaire_generation', 'action_plan')`);
        await queryRunner.query(`ALTER TABLE "ai_tasks" ALTER COLUMN "type" TYPE "public"."ai_task_type_enum_old" USING "type"::"text"::"public"."ai_task_type_enum_old"`);
        await queryRunner.query(`DROP TYPE "public"."ai_tasks_type_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."ai_task_type_enum_old" RENAME TO "ai_task_type_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."ai_model_enum_old" AS ENUM('gpt4', 'claude', 'domestic')`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" ALTER COLUMN "model" TYPE "public"."ai_model_enum_old" USING "model"::"text"::"public"."ai_model_enum_old"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."ai_model_enum_old" AS ENUM('gpt4', 'claude', 'domestic')`);
        await queryRunner.query(`ALTER TABLE "ai_generation_events" ALTER COLUMN "model" TYPE "public"."ai_model_enum_old" USING "model"::"text"::"public"."ai_model_enum_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD "resource_type" character varying NOT NULL`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_ai_cost_tracking_created_at" ON "ai_cost_tracking" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_ai_cost_tracking_model" ON "ai_cost_tracking" ("model") `);
        await queryRunner.query(`CREATE INDEX "IDX_ai_cost_tracking_task_id" ON "ai_cost_tracking" ("task_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_ai_generation_events_created_at" ON "ai_generation_events" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_ai_generation_events_model" ON "ai_generation_events" ("model") `);
        await queryRunner.query(`CREATE INDEX "IDX_ai_generation_events_task_id" ON "ai_generation_events" ("task_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "ai_tasks" ADD CONSTRAINT "FK_ai_tasks_project" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_cost_tracking" ADD CONSTRAINT "FK_ai_cost_tracking_task" FOREIGN KEY ("task_id") REFERENCES "ai_tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ai_generation_events" ADD CONSTRAINT "FK_ai_generation_events_task" FOREIGN KEY ("task_id") REFERENCES "ai_tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

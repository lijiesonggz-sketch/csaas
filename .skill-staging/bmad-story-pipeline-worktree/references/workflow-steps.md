...
Interpret this file as an ordered list of skill invocations.
...
- Run steps sequentially inside the story worktree.
...
After all steps succeed and merge completes:
